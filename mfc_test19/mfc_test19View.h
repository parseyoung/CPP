...
// mfc_test19View.h: Cmfctest19View 클래스의 인터페이스
//

#pragma once


class Cmfctest19View : public CFormView
{
protected: // serialization에서만 만들어집니다.
	Cmfctest19View() noexcept;
	DECLARE_DYNCREATE(Cmfctest19View)

public:
#ifdef AFX_DESIGN_TIME
	enum{ IDD = IDD_MFC_TEST19_FORM };
#endif
...
#ifndef _DEBUG  // mfc_test19View.cpp의 디버그 버전
